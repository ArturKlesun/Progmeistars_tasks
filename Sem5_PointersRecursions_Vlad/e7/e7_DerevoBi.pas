{
с помощью рекурсии построить бинарное дерево, которое пускает корни влево, когда дочерняя буква меньше; вправо - когда дочерняя буква больш
е, потом программа эти буквы выводит в алфавитном порядке, а потом диспоузит всё дерево.
}
